...
func (pu *ProductUpdate) SetDateUpdated(t time.Time) *ProductUpdate {
...
func (pu *ProductUpdate) defaults() {
	if _, ok := pu.mutation.DateUpdated(); !ok {
		v := product.UpdateDefaultDateUpdated()
...
// SetDateUpdated sets the "dateUpdated" field.
func (puo *ProductUpdateOne) SetDateUpdated(t time.Time) *ProductUpdateOne {
